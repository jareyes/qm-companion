...
\small\textbf{Quetsion.} Figure \ref{fig:mb-3-real-lines} shows three lines, each of which has been coordinatized by a different unit length. How are the coordinate systems related to one another?
